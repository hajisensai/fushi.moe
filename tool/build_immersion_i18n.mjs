...
const ZH = {
  ...
  what_h: '什么是沉浸？',
  what_p1: '去听、去读母语者给母语者做的内容：动画、小说、游戏、综艺这些真实的东西。你现在看的每一部番、玩的每一款游戏，都算沉浸。',
...
const ZH_HK = {
  ...
  what_h: '什麼是沉浸？',
  what_p1: '去聽、去讀母語者為母語者製作的內容：動畫、小說、遊戲、綜藝這些真實的東西。你現在看的每一部番、玩的每一款遊戲，都算沉浸。',
...
const EN = {
  ...
  what_p1: 'Listening to and reading things made by native speakers for native speakers: anime, novels, games, variety shows — the real thing. Every show you watch and every game you play already counts.',
...
const JA = {
  ...
  what_h: 'イマージョンとは？',
  what_p1: '母語話者が母語話者のために作ったもの——アニメ、小説、ゲーム、バラエティといった本物——を聞き、読むことです。今見ているアニメも、遊んでいるゲームも、すべてイマージョンです。',
...
const KO = {
  ...
  what_h: '몰입이란?',
  what_p1: '원어민이 원어민을 위해 만든 것 — 애니메이션, 소설, 게임, 예능 같은 진짜 — 를 듣고 읽는 것입니다. 지금 보는 애니메이션, 지금 하는 게임이 이미 몰입입니다.',
