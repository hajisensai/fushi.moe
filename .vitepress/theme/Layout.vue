  ...
  <div class="site-shell">
    <nav class="site-nav" id="top">
      ...
      <div class="site-nav-right">
        <input class="site-nav-check" type="checkbox" id="site-nav-check" aria-label="展开菜单">
        ...
        <span class="site-nav-links">
          <a href="/#acgn"><span class="site-nav-word">功能</span></a>
          <a href="/#method"><span class="site-nav-word">怎么开始</span></a>
          <a class="site-nav-ico" href="https://qm.qq.com/q/Sx2nWTvJCw" title="QQ 群"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21.395 15.035a40 40 0 0 0-.803-2.264l-1.079-2.695c.001-.032.014-.562.014-.836C19.526 4.632 17.351 0 12 0S4.474 4.632 4.474 9.241c0 .274.013.804.014.836l-1.08 2.695a39 39 0 0 0-.802 2.264c-1.021 3.283-.69 4.643-.438 4.673.54.065 2.103-2.472 2.103-2.472 0 1.469.756 3.387 2.394 4.771-.612.188-1.363.479-1.845.835-.434.32-.379.646-.301.778.343.578 5.883.369 7.482.189 1.6.18 7.14.389 7.483-.189.078-.132.132-.458-.301-.778-.483-.356-1.233-.646-1.846-.836 1.637-1.384 2.393-3.302 2.393-4.771 0 0 1.563 2.537 2.103 2.472.251-.03.581-1.39-.438-4.673"/></svg><span class="site-nav-word">QQ 群</span></a>
    ...
    <footer class="site-footer">
      <nav class="site-footer-links">
        <a href="/#acgn">功能</a><a href="/#method">怎么开始</a><a href="/download">下载</a><a href="https://github.com/hajisensai/Fushi">GitHub</a><a href="https://discord.gg/WhjwyGmm7f">Discord</a><a href="https://qm.qq.com/q/Sx2nWTvJCw">QQ 群</a>
      </nav>
      <p class="site-footer-legal">自由软件 · 以 <a href="https://www.gnu.org/licenses/gpl-3.0.html">GPLv3</a> 许可发布</p>
      <p>© 2026 Fushi</p>
    </footer>
  </div>
</template>
