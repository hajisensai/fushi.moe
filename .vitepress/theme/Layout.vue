    ...
    <nav class="site-nav" id="top">
      ...
      <div class="site-nav-right">
        ...
        <span class="site-nav-links">
          <a href="/#acgn"><span class="site-nav-word" data-i18n="nav.features">功能</span></a>
        ...
        <label class="site-nav-lang" title="语言" data-i18n-attr="title=nav.language">
          ...
          <select class="site-nav-lang-select" aria-label="语言" data-i18n-attr="aria-label=nav.language">
            <option value="auto" data-i18n="nav.lang_auto">自动</option>
