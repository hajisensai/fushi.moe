    ...
    <nav class="site-nav vp-raw" id="top">
      ...
      <div class="site-nav-right">
        ...
        <span class="site-nav-links">
          <a href="/zh-cn/immersion" data-i18n-attr="href=nav.method_href"><span class="site-nav-word" data-i18n="nav.method">怎么开始</span></a>
