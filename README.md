...
immersion.md            # 沉浸学习指南英文版（默认路由）；<lang>/immersion.md 是其余 16 种语言的静态版（链接预览用），17 页 + 字典键 imm.* 由 tool/build_immersion_i18n.mjs 生成（文案在 tool/immersion_translations_extra.mjs）
