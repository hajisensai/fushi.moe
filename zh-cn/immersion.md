...
head:
  ...
  - - meta
    - property: "og:url"
      content: "https://fushi.moe/zh-cn/immersion"
  - - meta
    - property: "og:locale"
      content: "zh_CN"
  - - meta
...
<p data-i18n="imm.what.p4">沉浸在最开始确实会有一段什么都不懂的阶段，但因为你选的是自己喜欢的内容，即使不完全听懂也能看下去。不管进步是快是慢、懂多还是懂少，你对这些内容的兴趣才是最重要的。</p>
